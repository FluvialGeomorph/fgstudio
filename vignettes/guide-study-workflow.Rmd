...
After **Analysis setup**, use **Continue to Define a Survey Event** or open the
adjacent **Define a Survey Event** main tab. Select from **Saved Survey Collections for this Survey
...
apply across Survey Events; equal cell sizes align. Changed selection/CRS evidence is
...
verified and reused when you reopen the Event.

Use **Mask to view** to inspect the completed Study Area, Stream and Reach masks.
Blue shows included cells and orange shows the saved boundary. The overview is
sampled for display; saved masks retain the full cell size. To correct boundaries,
use **Study geometry**; to change spacing, use **Review / edit Survey Event**.
Saving corrections updates masks automatically. **Pause mask preparation** stops
background work without discarding published masks. Reopening the Event resumes.
